...
const stripePromise = loadStripe('pk_test_51L41FqKhke4uehzidYDB6c9vLUesOrKUWQO4FeYWcQThh0NC3Z2BN7yDB5gsEpcAkkkJQHAz0AcLkDY4MIAOqR1E00JuQbLypt');
const Payment = () => {
    const { id } = useParams();
    const url = `https://young-river-14403.herokuapp.com/orders/${id}`;
